...
namespace TestGenerics
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(OtraClase.MetodoEstatico(mcd, parametro)); //Aqui se inferira que el primer parametro pasado es del tipo de dato requerido, por lo tanto da lo mismo hacerlo de modo explicito como en la anterior linea
